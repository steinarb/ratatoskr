...
class VideoTest {
    ...
    void testCreate() {
        ...
        var image = Video.with()
            .width(width)
            .height(height)
            .blurhash(blurhash)
            .build();

        assertThat(image.type()).isEqualTo(ActivityStreamObjectType.Video);
    ...
    void testCopy() {
        ...
        var originalDocument = Video.with()
            .width(width)
            .height(height)
            .blurhash(blurhash)
            .build();

        var copiedDocument = Video.with(originalDocument).build();
    ...
    @Test
    void testCopyNull() {
        var copyOfNull = Video.with(null).build();
        assertThat(copyOfNull).hasAllNullFieldsOrPropertiesExcept("type", "width", "height");
        assertThat(copyOfNull.type()).isEqualTo(ActivityStreamObjectType.Video);
    }
