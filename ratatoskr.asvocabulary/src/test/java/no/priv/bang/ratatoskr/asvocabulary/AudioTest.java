...
class AudioTest {
    ...
    void testCreate() {
        ...
        var image = Audio.with()
            .width(width)
            .height(height)
            .blurhash(blurhash)
            .build();

        assertThat(image.type()).isEqualTo(ActivityStreamObjectType.Audio);
    ...
    void testCopy() {
        ...
        var originalDocument = Audio.with()
            .width(width)
            .height(height)
            .blurhash(blurhash)
            .build();

        var copiedDocument = Audio.with(originalDocument).build();
    ...
    @Test
    void testCopyNull() {
        var copyOfNull = Audio.with(null).build();
        assertThat(copyOfNull).hasAllNullFieldsOrPropertiesExcept("type", "width", "height");
        assertThat(copyOfNull.type()).isEqualTo(ActivityStreamObjectType.Audio);
    }
