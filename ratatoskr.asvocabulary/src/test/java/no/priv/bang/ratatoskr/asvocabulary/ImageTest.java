...
class ImageTest {
    ...
    void testCreate() {
        ...
        assertThat(image.type()).isEqualTo(ActivityStreamObjectType.Image);
    ...
    void testCopy() {
        ...
        var originalDocument = Image.with()
            .width(width)
            .height(height)
            .blurhash(blurhash)
            .build();

        var copiedDocument = Image.with(originalDocument).build();
    ...
    @Test
    void testCopyNull() {
        var copyOfNull = Image.with(null).build();
        assertThat(copyOfNull).hasAllNullFieldsOrPropertiesExcept("type", "width", "height");
        assertThat(copyOfNull.type()).isEqualTo(ActivityStreamObjectType.Image);
    }
