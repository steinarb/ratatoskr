...
class ActivityStreamObjectTest {
    ...
    void testCreateObject() {
        ...
        var asobject = ActivityStreamObject.with()
        ...
        assertThat(asobject.type()).isEqualTo(ActivityStreamObjectType.Object);
    ...
    @Test
    void testCopyObject() {
        var original = ActivityStreamObject.with()
            .id("https://someserver.somedomain")
            .name("Test Name")
            .nameMap(Map.of("en", "Test Name"))
            .summary("Test Summary")
        ...
        var copy = ActivityStreamObject.with(original).build();
    ...
    void testCopyAndMutateObject() {
        ...
        var mutatedCopy = ActivityStreamObject.with(original)
            .name("Replace")
            .build();
