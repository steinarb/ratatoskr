...
public record Article(
    ...
    public static Builder with(Article article) {
        var builder = new Builder();
        builder.context = article.context();
        builder.id = article.id();
        builder.name = article.name();
        builder.nameMap = article.nameMap();
        builder.summary = article.summary();
        builder.summaryMap = article.summaryMap();
        builder.content = article.content();
        builder.contentMap = article.contentMap();
        builder.mediaType = article.mediaType();
        builder.url = article.url();
        builder.attributedTo = article.attributedTo();
        builder.duration = article.duration();
        builder.startTime = article.startTime();
        builder.endTime = article.endTime();
        builder.published = article.published();
        builder.updated = article.updated();
        builder.attachment = article.attachment();
        builder.audience = article.audience();
        builder.to = article.to();
        builder.bcc = article.bcc();
        builder.bto = article.bto();
        builder.cc = article.cc();
        builder.generator = article.generator();
        builder.icon = article.icon();
        builder.image = article.image();
        builder.inReplyTo = article.inReplyTo();
        builder.location = article.location();
    ...
    public static class Builder {
        ...
        public Article build() {
            return new Article(
                context,
                ActivityStreamObjectType.Article,
                id,
                name,
                nameMap,
                summary,
