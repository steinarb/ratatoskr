...
) implements ActivityStreamObject
{
    ...
    public static Builder with(Group group) {
        var builder = new Builder();
        builder.id = group.id();
        builder.name = group.name();
        builder.summary = group.summary();
        builder.icon = group.icon();
        return builder;
    }

    public static class Builder {
        private Object context = "https://www.w3.org/ns/activitystreams";
        private ActivityStreamObjectType type = ActivityStreamObjectType.Group;
        private String id;
        private String name;
