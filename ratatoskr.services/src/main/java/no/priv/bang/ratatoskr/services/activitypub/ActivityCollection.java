...
public record ActivityCollection(
    String id,
    int totalItems,
    Activity current,
    Activity first,
    Activity last,
    List<Activity> orderedItems
)
{
    ...
    public static class Builder {
        ...
        private List<Activity> orderedItems;
        ...
        public Builder current(Activity current) {
            this.current = current;
            return this;
        }

        public Builder orderedItems(List<Activity> orderedItems) {
